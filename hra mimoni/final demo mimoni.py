...
def aktualizuj_zivoty():
    ...
    platno.create_text(10, 30, text=f"Životy: {zivoty_mimon_1}",
                       font=("Helvetica", 16), fill="red", anchor="nw", tag="zivoty")
    platno.create_text(420, 30, text=f"Životy: {zivoty_mimon_2}",
                       font=("Helvetica", 16), fill="red", anchor="nw", tag="zivoty")
...
def pridaj_banan():
    ...
    banany.append(banan)
    okno.after(5000, lambda: zmizni_banan(banan))  # Banán zmizne po 1 sekunde
    okno.after(2000, pridaj_banan)  # Pridáva banány každé 3 sekundy
...
# Spustenie pridávania banánov a jahôd
pridaj_banan()
pridaj_jahodu()
